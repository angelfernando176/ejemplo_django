"""
Django settings for empleado_django1 project.
...
SECRET_KEY = 'django-insecure-f*a*j%hnt(aw24)d33kmbgh06#f-bcu+f&j^$izp%l&m06#$4e'
...
WSGI_APPLICATION = 'empleado_django1.wsgi.application'
